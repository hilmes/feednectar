# 
# Extensions to Hpricot classes, to provide RSS-ish method accessors
#
# Author: Unkown
#
# http://choonkeat.svnrepository.com/svn/rails-plugins/misc/hpricot/rss.rb
#
# Usage example:
# <code>
#   doc = Hpricot.XML(data)
#   doc.entries.each {|entry| [entry.title, entry.url] }
# </code>
# 
require 'hpricot'
require 'iconv'
